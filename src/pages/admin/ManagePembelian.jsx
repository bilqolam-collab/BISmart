...
const ManagePembelian = () => {
  const { kitabOrders, updateKitabOrderStatus, updateKitabPrices } = useAppContext();
        ...
        <div className="print-area">
          <div className="print-header">
            <div className="print-logo">
              <h1 className="logo-text">Bilqolam</h1>
            </div>
            <div className="print-company-info">
              <h2>Struk Pembelian Kitab & Perlengkapan</h2>
              <p>a.n Bilqolam Singosari-Malang</p>
              <p>Jl. Pesantren No.1, Singosari, Malang</p>
            </div>
          </div>
